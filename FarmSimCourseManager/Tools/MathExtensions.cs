...
namespace FarmSimCourseManager.Tools
{
    ...
    /// <seealso cref="https://blogs.msdn.microsoft.com/kaelr/2008/05/12/mathextensions/"/>
    public static class MathExtensions
    {
        ...
        /// <summary>Returns a value indicating whether the specified number evaluates to a value that is not a number (<see cref="F:System.Single.NaN"/>).</summary>
        /// <returns>true if value evaluates to <see cref="F:System.Single.NaN"/>; otherwise, false.</returns>
        /// <param name="value">A single-precision floating-point number. </param>
        /// <filterpriority>1</filterpriority>
        public static bool IsNaN(this float value) { return float.IsNaN(value); }

        /// <summary>Returns a value indicating whether the specified number evaluates to a value that is positive infinity (<see cref="F:System.Double.PositiveInfinity"/>).</summary>
        /// <returns>true if value evaluates to <see cref="F:System.Double.PositiveInfinity"/>; otherwise, false.</returns>
        /// <param name="value">A double-precision floating-point number. </param>
        /// <filterpriority>1</filterpriority>
        public static bool IsPositiveInfinity(this double value) { return double.IsPositiveInfinity(value); }
        /// <summary>Returns a value indicating whether the specified number evaluates to a value that is positive infinity (<see cref="F:System.Single.PositiveInfinity"/>).</summary>
        /// <returns>true if value evaluates to <see cref="F:System.Single.PositiveInfinity"/>; otherwise, false.</returns>
        /// <param name="value">A single-precision floating-point number. </param>
        /// <filterpriority>1</filterpriority>
        public static bool IsPositiveInfinity(this float value) { return float.IsPositiveInfinity(value); }

        /// <summary>Returns a value indicating whether the specified number evaluates to a value that is negative infinity (<see cref="F:System.Double.NegativeInfinity"/>).</summary>
        /// <returns>true if value evaluates to <see cref="F:System.Double.NegativeInfinity"/>; otherwise, false.</returns>
        /// <param name="value">A double-precision floating-point number. </param>
        /// <filterpriority>1</filterpriority>
        public static bool IsNegativeInfinity(this double value) { return double.IsNegativeInfinity(value); }
        /// <summary>Returns a value indicating whether the specified number evaluates to a value that is negative infinity (<see cref="F:System.Single.NegativeInfinity"/>).</summary>
        /// <returns>true if value evaluates to <see cref="F:System.Single.NegativeInfinity"/>; otherwise, false.</returns>
        /// <param name="value">A single-precision floating-point number. </param>
        /// <filterpriority>1</filterpriority>
        ...
        /// <param name="value">A double-precision floating-point number. </param>
        /// <param name="defaultValue">The value to return if <see cref="System.Double.IsNaN"/> returns true.</param>
        ...
        /// <param name="value">A single-precision floating-point number. </param>
        public static float GetValueOrDefault(this float value) { return float.IsNaN(value) ? 0.0f : value; }
        ...
        /// <param name="value">A single-precision floating-point number. </param>
        /// <param name="defaultValue">The value to return if <see cref="System.Single.IsNaN"/> returns true.</param>
        public static float GetValueOrDefault(this float value, float defaultValue) { return float.IsNaN(value) ? defaultValue : value; }
        ...
        public static IEnumerable<decimal> To(this decimal start, decimal bound) { var step = start <= bound ? (decimal)1 : (decimal)-1; for (var i = start; i < bound; i += step) yield return i; }
        /// <summary>Generates a sequence of decimal numbers within a specified range.</summary>
        ...
        /// <param name="start">The number to start from.</param>
        /// <param name="bound">The number to stop before.</param>
        public static IEnumerable<decimal> To(this decimal start, decimal bound, decimal step) { for (var i = start; i < bound; i += step) yield return i; }
        /// <summary>Generates a sequence of double-precision floating-point values within a specified range.</summary>
        /// <returns>A sequence of numbers from start to (but not including) bound where each number is 1 greater than the previous number.</returns>
        /// <param name="start">The number to start from.</param>
        /// <param name="bound">The number to stop before.</param>
        public static IEnumerable<double> To(this double start, double bound) { var step = start <= bound ? (double)1 : (double)-1; for (var i = start; i < bound; i += step) yield return i; }
        /// <summary>Generates a sequence of double-precision floating-point values within a specified range.</summary>
        /// <returns>A sequence of numbers from start to (but not including) bound where each number is a given step greater than the previous number.</returns>
        /// <param name="start">The number to start from.</param>
        /// <param name="bound">The number to stop before.</param>
        public static IEnumerable<double> To(this double start, double bound, double step) { for (var i = start; i < bound; i += step) yield return i; }
        /// <summary>Generates a sequence of single-precision floating-point values within a specified range.</summary>
        /// <returns>A sequence of numbers from start to (but not including) bound where each number is 1 greater than the previous number.</returns>
        /// <param name="start">The number to start from.</param>
        /// <param name="bound">The number to stop before.</param>
        public static IEnumerable<float> To(this float start, float bound) { var step = start <= bound ? (float)1 : (float)-1; for (var i = start; i < bound; i += step) yield return i; }
        /// <summary>Generates a sequence of single-precision floating-point values within a specified range.</summary>
        /// <returns>A sequence of numbers from start to (but not including) bound where each number is a given step greater than the previous number.</returns>
        /// <param name="start">The number to start from.</param>
        /// <param name="bound">The number to stop before.</param>
        public static IEnumerable<float> To(this float start, float bound, float step) { for (var i = start; i < bound; i += step) yield return i; }
        /// <summary>Generates a sequence of 64-bit signed integers within a specified range.</summary>
        /// <returns>A sequence of numbers from start to (but not including) bound where each number is 1 greater than the previous number.</returns>
        /// <param name="start">The number to start from.</param>
        /// <param name="bound">The number to stop before.</param>
        public static IEnumerable<long> To(this long start, long bound) { var step = start <= bound ? (long)1 : (long)-1; for (var i = start; i < bound; i += step) yield return i; }
        /// <summary>Generates a sequence of 64-bit signed integers within a specified range.</summary>
        /// <returns>A sequence of numbers from start to (but not including) bound where each number is a given step greater than the previous number.</returns>
        /// <param name="start">The number to start from.</param>
        /// <param name="bound">The number to stop before.</param>
        public static IEnumerable<long> To(this long start, long bound, long step) { for (var i = start; i < bound; i += step) yield return i; }
        /// <summary>Generates a sequence of 32-bit signed integers within a specified range.</summary>
        /// <returns>A sequence of numbers from start to (but not including) bound where each number is 1 greater than the previous number.</returns>
        /// <param name="start">The number to start from.</param>
        /// <param name="bound">The number to stop before.</param>
        public static IEnumerable<int> To(this int start, int bound) { var step = start <= bound ? (int)1 : (int)-1; for (var i = start; i < bound; i += step) yield return i; }
        /// <summary>Generates a sequence of 32-bit signed integers within a specified range.</summary>
        /// <returns>A sequence of numbers from start to (but not including) bound where each number is a given step greater than the previous number.</returns>
        /// <param name="start">The number to start from.</param>
        /// <param name="bound">The number to stop before.</param>
        public static IEnumerable<int> To(this int start, int bound, int step) { for (var i = start; i < bound; i += step) yield return i; }
        /// <summary>Generates a sequence of 16-bit signed integers within a specified range.</summary>
        /// <returns>A sequence of numbers from start to (but not including) bound where each number is 1 greater than the previous number.</returns>
        /// <param name="start">The number to start from.</param>
        /// <param name="bound">The number to stop before.</param>
        public static IEnumerable<short> To(this short start, short bound) { var step = start <= bound ? (short)1 : (short)-1; for (var i = start; i < bound; i += step) yield return i; }
        /// <summary>Generates a sequence of 16-bit signed integers within a specified range.</summary>
        /// <returns>A sequence of numbers from start to (but not including) bound where each number is a given step greater than the previous number.</returns>
        /// <param name="start">The number to start from.</param>
        /// <param name="bound">The number to stop before.</param>
        public static IEnumerable<short> To(this short start, short bound, short step) { for (var i = start; i < bound; i += step) yield return i; }
